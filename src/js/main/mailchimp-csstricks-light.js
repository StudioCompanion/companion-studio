...
var showError = function (field, error) {
	...
	// If not, create one
	var message = field.form.querySelector('.inline-error');
	console.log(message);
	if (!message) {
...
var removeError = function (field) {
	...
	var message = field.form.querySelector('.inline-error#error-for-' + id + '');
	if (!message) return;
...
window.displayMailChimpStatus = function (data) {
	...
	// Update our status message
		...
		var formattedError = data.msg.replace(/^\d\s-\s/i, '');

	mcStatus.innerHTML = formattedError;

	// If error, add error class
	if (data.result === 'error') {
		mcStatus.classList.remove('success-message');
		mcStatus.classList.add('inline-error');
		return;
	}

	// Otherwise, add success class
	mcStatus.classList.remove('inline-error');
