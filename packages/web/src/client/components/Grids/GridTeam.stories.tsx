...
export const NoMembers: ComponentStory<typeof TeamGrid> = () => (
  <TeamGrid {...fixtures.noMembers} />
)

export const WithMembers: ComponentStory<typeof TeamGrid> = () => (
  <TeamGrid {...fixtures.withMembers} />
)

const fixtures: StoryFixtures<typeof TeamGrid> = {
  noMembers: {},
  withMembers: {
    team: [
      {
